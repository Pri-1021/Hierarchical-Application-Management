    ...
    <div class="container">
        ...
        foreach ($applications as $application) {
            ...
            if ($show_row) {
                ...
                if ($dynamic_role == 'director') {
                    ...
                    echo "<a href='approve.php?id=" . htmlspecialchars($id) . "&dynamic_role=" . htmlspecialchars($dynamic_role) . "'>recmonned</a> | ";
                    echo "<a href='reject.php?id=" . htmlspecialchars($id) . "&dynamic_role=" . htmlspecialchars($dynamic_role) . "'>not recmonned</a> | ";
                }
                echo "<a href='view_application.php?id=" . htmlspecialchars($id) . "' class='view-button'>View Full Application</a>";
                if($dynamic_role == 'director'){
                    echo " | <a href='headquarters.php?id=" . htmlspecialchars($id) . "&dynamic_role=" . htmlspecialchars($dynamic_role) . "' class='view-button'>Headquarters permission required</a>";
                }
                echo "</td></tr>";
            }
        }        
        ...
        foreach ($applications as $application) {
            if ((
                ...
                echo "<tr><td>" . htmlspecialchars($application["seminar_id"]) . "</td><td>" . htmlspecialchars($application["name_of_applicant"]) . "</td><td>" . htmlspecialchars($application["designation"]) . "</td><td>" . htmlspecialchars($application["name_of_seminar"]) . "</td><td>" . htmlspecialchars($application["from_date"]) . "</td><td>" . htmlspecialchars($application["to_date"]) . "</td><td>" . htmlspecialchars($application["location"]) . "</td>";
                echo "<td class='action-links'><a href='view_application.php?id=" . htmlspecialchars($application["id"]) . "' class='view-button'>View Full Application</a></td></tr>";
            }
        }
        echo "</table>";
